...
namespace school1.REST.Services
{
    public class FakeCourseService : ICrudServiceAsync<CourseModel>
    {
        ...
        {
            // Тестові дані
            var course1 = new CourseModel { Id = 1, Title = "Геометрія", Credits = 5 };
            var course2 = new CourseModel { Id = 2, Title = "Алгебра", Credits = 4 };
            var course3 = new CourseModel { Id = 3, Title = "Програмування", Credits = 3 };
