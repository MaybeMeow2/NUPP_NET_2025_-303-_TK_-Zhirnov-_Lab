...
using school1.REST.Interfaces;

namespace school1.REST.Services
{
    public class FakeStudentService : ICrudServiceAsync<StudentModel>
    {
        ...
        public FakeStudentService(FakeStudentAddressService addressService)
        {
            ...
            var student1 = new StudentModel
            {
                ...
                Address = new StudentAddressModel { Id = 1, Address = "вул. Залізнична, 13", City = "Харків", Country = "Україна" }
            };
            ...
            var student2 = new StudentModel
            {
                ...
                FirstName = "Марія",
                LastName = "Татьяненко",
                BirthDate = new DateTime(2007, 8, 19),
                Address = new StudentAddressModel { Id = 2, Address = "пр. Павлова, 26", City = "Київ", Country = "Україна" }
            };
